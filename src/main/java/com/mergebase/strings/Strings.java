...
public class Strings {
    ...
    public static boolean isYaml(Path p) {
        String f = p.getFileName().toString().toLowerCase(Locale.ENGLISH);
        return f.endsWith(".yaml") || f.endsWith(".yml");
    }

    public static boolean isPom(Path p) {
        String f = p.getFileName().toString().toLowerCase(Locale.ENGLISH);
        return f.endsWith(".pom") || f.equals("pom.xml");
    }

    public static boolean isJson(Path p) {
        String f = p.getFileName().toString().toLowerCase(Locale.ENGLISH);
